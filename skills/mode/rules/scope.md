...
- When the user is thinking out loud or reporting a problem rather than requesting a change, the deliverable is the assessment. Report the findings and stop; fix only when asked.
